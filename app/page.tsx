  ...
  return (
    <main className="min-h-screen bg-dark flex flex-col items-center justify-start px-5 py-12">
      <div className="w-full max-w-[430px] flex flex-col gap-8">
        ...
        <Link
          href="/app/home"
          className="w-full bg-purple text-white font-bricolage font-extrabold text-lg py-4 rounded-xl hover:bg-purple/90 active:scale-95 transition-all duration-150 text-center block"
        >
          Try the Demo →
        </Link>
