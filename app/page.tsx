...
export default function Home() {
  ...
  async function handleGoogleSignIn() {
    ...
    // Will redirect away, no need to unset loading
  }
        ...
        {!authLoading && (
          <div className="flex flex-col gap-3">
            {user ? (
              <Link
                href="/app/home"
                className="w-full bg-purple text-white font-bricolage font-extrabold text-lg py-4 rounded-xl hover:bg-purple/90 active:scale-95 transition-all duration-150 text-center"
              >
                Go to your map →
              </Link>
            ) : (
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 font-jakarta font-semibold text-base py-4 rounded-xl hover:bg-white/90 active:scale-95 transition-all duration-150 disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {googleLoading ? (
                  ...
                  <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    />
                    <path
                      d="M9 18c2.43 0 4.4673-.806 5.9564-2.1805l-2.9087-2.2581c-.806.54-1.8368.859-3.0477.859-2.3446 0-4.3282-1.5836-5.036-3.7105H.9574v2.3318C2.4382 15.9832 5.4818 18 9 18z"
                      fill="#34A853"
                    />
                    <path
                      d="M3.964 10.71c-.18-.54-.2818-1.1168-.2818-1.71s.1018-1.17.2818-1.71V4.9582H.9574C.3477 6.1732 0 7.5482 0 9s.3477 2.8268.9574 4.0418L3.964 10.71z"
                      fill="#FBBC05"
                    />
                    <path
